...
const Page = () => {
    ...
    // Получаем pathname без ведущего слэша
    ...
    const fetchData = useCallback(async (pageNumber) => {
        ...
        try {
            const { url, headers } = getUrl(pageNumber, [seachValue, cleanPathname].join(' ')); // Получаем URL и заголовки
